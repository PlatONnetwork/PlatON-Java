 ...
 * freely to and from ENERGON as required. ENERGON does not exist outside of the internal Ethereum
 * computation engine; its price is set by the Transaction and miners are free to
 * ignore Transactions whose ENERGON price is too low.
 */
public class EnergonCost {
    ...
    private final int GENESISENERGONLIMIT = 1000000;
    private final int MINENERGONLIMIT = 125000;
    ...
    private final int LOG_ENERGON = 375;
    private final int LOG_DATA_ENERGON = 8;
    private final int LOG_TOPIC_ENERGON = 375;
    private final int COPY_ENERGON = 3;
    private final int EXP_ENERGON = 10;
    private final int EXP_BYTE_ENERGON = 10;
    ...
    public int getGENESISENERGONLIMIT() {
        return GENESISENERGONLIMIT;
    }

    public int getMINENERGONLIMIT() {
        return MINENERGONLIMIT;
    }
    ...
    public int getLOG_ENERGON() {
        return LOG_ENERGON;
    }

    public int getLOG_DATA_ENERGON() {
        return LOG_DATA_ENERGON;
    }

    public int getLOG_TOPIC_ENERGON() {
        return LOG_TOPIC_ENERGON;
    }

    public int getCOPY_ENERGON() {
        return COPY_ENERGON;
    }

    public int getEXP_ENERGON() {
        return EXP_ENERGON;
    }

    public int getEXP_BYTE_ENERGON() {
        return EXP_BYTE_ENERGON;
    }
