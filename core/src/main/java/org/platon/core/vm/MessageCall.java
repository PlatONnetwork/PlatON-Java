...
public class MessageCall {
    ...
    /**
     * Energon to pay for the call, remaining Energon will be refunded to the caller
     */
    private final DataWord energon;
    /**
    ...
    public MessageCall(OpCode type, DataWord Energon, DataWord codeAddress,
    ...
    public MessageCall(OpCode type, DataWord Energon, DataWord codeAddress,
        ...
        this(type, Energon, codeAddress, endowment, inDataOffs, inDataSize);
